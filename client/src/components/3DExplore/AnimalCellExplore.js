            ...
            return (
                <div className="h-full md:flex md:flex-col md:justify-center font-fontVollkorn">
                    ...
                    <p className="text-xl text-justify mt-4">
                        ...
                        nucleus that manufactures ribosomes, the cell's
                        protein-producing structures. Through the microscope,
                        the nucleolus looks like a large dark spot within the
                        nucleus.
                    </p>
                </div>
            );
            ...
            return (
                <div className="h-full md:flex md:flex-col md:justify-center font-fontVollkorn">
                    ...
                    <p className="text-xl text-justify mt-4">
                        ...
                        contains digestive enzymes. They break down excess or
                        worn-out cell parts. They may be used to destroy
            ...
            return (
                <div className="h-full md:flex md:flex-col md:justify-center font-fontVollkorn">
                    ...
                    <p className="text-xl text-justify mt-4">
                        ...
                        membrane system that forms a series of flattened sacs
                        within the cytoplasm of eukaryotic cells and serves
                        multiple functions, being important particularly in the
                        synthesis, folding, modification, and transport of
                        proteins.
                    </p>
                </div>
            );
        case "Material.004":
            return (
                <div className="h-full md:flex md:flex-col md:justify-center font-fontVollkorn">
                    ...
                    <p className="text-xl text-justify mt-4">
                        The cytoplasm is the gel-like fluid inside the cell. It
                        is the medium for chemical reaction. It provides a
