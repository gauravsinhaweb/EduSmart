            ...
            return (
                <div className="h-full md:flex md:flex-col md:justify-center font-fontVollkorn">
                    ...
                    <p className="text-xl text-justify mt-4">
                        The internal cabin width is increased from the previous
                        777 models' 231 to 235 in (587 to 597 cm) through
                        thinner interior cabin walls and better insulation to
                        allow 18.0 in (46 cm) wide seats in 10-abreast economy.
                    </p>
                </div>
            );
        case "FUZEL-FACES_0":
            return (
                <div className="h-full md:flex md:flex-col md:justify-center font-fontVollkorn">
                    ...
                    <p className="text-xl text-justify mt-4">
                        ...
                        front of an aircraft or spacecraft, from which a pilot
        ...
        case "DVIGATEL-FACES_1":
            return (
                <div className="h-full md:flex md:flex-col md:justify-center font-fontVollkorn">
                    ...
                    <p className="text-xl text-justify mt-4">
                        The 777 Classics were powered by 77,200–98,000 lbf
                        (343–436 kN) General Electric GE90, Pratt & Whitney
        ...
        case "KIL-FACES":
            return (
                <div className="h-full md:flex md:flex-col md:justify-center font-fontVollkorn">
                    ...
                    <p className="text-xl text-justify mt-4">
                        A vertical stabilizer, vertical stabiliser, or fin, is a
                        structure designed to reduce aerodynamic side slip and
        ...
        case "KRILO_LEV01-FACES":
            return (
                <div className="h-full md:flex md:flex-col md:justify-center font-fontVollkorn">
                    ...
                    <p className="text-xl text-justify mt-4">
                        The 777X has a new longer composite wing with folding
                        wingtips.[68] Due to this, the 777x is the first
                        aircraft to have 'Wingtip Controls' inside the cockpit.
                    </p>
                </div>
            );
        default:
