        ...
        <div className="md:grid md:grid-cols-2 lg:mx-20 sm:mx-4">
          ...
          <div className="mt-5 md:mt-0">
            <div className="md:flex md:flex-col md:justify-center ">
              ...
              Jupiter is called a gas giant planet. Its atmosphere is made up of mostly hydrogen gas and helium gas, like the sun. The planet is covered in thick red, brown, yellow and white clouds. The clouds make the planet look like it has stripes.              </p>
