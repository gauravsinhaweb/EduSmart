...
import { Environment, OrbitControls, ContactShadows, MapControls , Stars} from "@react-three/drei";
        ...
        <div className="md:grid md:grid-cols-2 lg:mx-20 sm:mx-4">
          ...
          <div className="mt-5 md:mt-0">
            <div className="md:flex md:flex-col md:justify-center ">
              ...
              Mars is the fourth planet from the Sun and the next planet beyond Earth. ... Mars is about half the size of Earth. Mars is known as the Red Planet because the iron oxide chemicals in its soil looks like rust. Mars is named for the ancient Roman god of war.              </p>
