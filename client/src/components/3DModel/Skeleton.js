                    ...
                    <div className="mt-5 md:mt-0">
                        <div className="md:flex md:flex-col md:justify-center ">
                            ...
                            <p className="self-center mx-8 text-lg font-medium tracking-wide text-justify text-white">
                                Skeleton, the supportive framework of an animal
                                body. The skeleton of invertebrates, which may
                                be either external or internal, is composed of a
                                variety of hard nonbony substances.
                            </p>
