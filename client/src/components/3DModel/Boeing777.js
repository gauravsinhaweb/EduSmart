                    ...
                    <div className="mt-5 md:mt-0">
                        <div className="md:flex md:flex-col md:justify-center ">
                            ...
                            <p className="self-center mx-8 text-lg font-medium tracking-wide text-justify text-white">
                                The Boeing 777, commonly referred to as the
                                Triple Seven, is an American wide-body airliner
                                developed and manufactured by Boeing Commercial
                                Airplanes. It is the world's largest twinjet.
                                The 777 was designed to bridge the gap between
                                Boeing's 767 and 747, and to replace older
                                DC-10s and L-1011s.
                            </p>
                            ...
                            <p className="self-center mt-2 mx-8 text-lg tracking-wide text-center text-white">
                                To view the 3D model in AR, scan the QR code or
