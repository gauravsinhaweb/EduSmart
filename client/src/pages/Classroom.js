  ...
  return (
    <>
      <div className="w-full mb-4">
        <div className="text-3xl text-white font-extralight mt-8 text-center">Classroom🎓</div>
        ...
        <div className="flex justify-center items-center lg:justify-around lg:flex-row flex-col mt-5 lg:mt-16  opacity-90">
          ...
          <div className="opacity-60">
            ...
            <img src={ClassRoomImg} alt="classroom" className="object-contain h-64 my-3 w-full" />
          </div>
        </div>
      </div>
    </>
