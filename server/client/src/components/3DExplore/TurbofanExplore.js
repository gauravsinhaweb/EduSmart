  ...
  if (snap.current === "hull") {
    ...
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        ...
        <p className="text-xl text-justify mt-4">
          A turbine is a device that harnesses the kinetic energy of some fluid
          - such as water, steam, air, or combustion gases - and turns this into
          the rotational motion of the device itself.
        </p>
      </div>
    );
  } else {
