                ...
                <div className="md:grid md:grid-cols-2 lg:mx-20 sm:mx-4">
                    ...
                    <div className="mt-5 md:mt-0">
                        <div className="md:flex md:flex-col md:justify-center ">
                            ...
                            <h2 className="self-center mx-8 mb-4 text-3xl font-medium tracking-wide text-white">Animal Cell</h2>

                            <p className="self-center mx-8 text-lg font-medium tracking-wide text-justify text-white">Animal cells are typical of the eukaryotic cell, enclosed by a plasma membrane and containing a membrane-bound nucleus and organelles. Unlike the eukaryotic cells of plants and fungi, animal cells do not have a cell wall.
                            </p>
                            ...
                            <div className="grid justify-center grid-cols-1 gap-6 pb-8 mx-8 md:grid-cols-2 lg:grid-cols-2">
                                <img className="flex p-6 text-6xl rounded-xl h-60 w-60" src="https://storage.echoar.xyz/wispy-violet-4999/5aeeccb7-4186-4d71-9dde-4f06e35c5d83" alt="Animal Cell QR" />
                                <a href="https://go.echoar.xyz/QdET" target="_blank" rel="noreferrer">
